    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<c:url value="/WEB-INF/jsp/pages/layout/top-nav.html"/>"><i class="fa fa-circle-o"></i> Top Navigation</a></li>
            <li><a href="<c:url value="/WEB-INF/jsp/pages/layout/boxed.html"/>"><i class="fa fa-circle-o"></i> Boxed</a></li>
            <li><a href="<c:url value="/WEB-INF/jsp/pages/layout/fixed.html"/>"><i class="fa fa-circle-o"></i> Fixed</a></li>
            <li><a href="<c:url value="/WEB-INF/jsp/pages/layout/collapsed-sidebar.html"/>"><i class="fa fa-circle-o"></i> Collapsed Sidebar</a></li>
          </ul>
        </li>
        <li>
          <a href="<c:url value="/WEB-INF/jsp/pages/widgets.html"/>">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<c:url value="/WEB-INF/jsp/pages/charts/chartjs.html"/>"><i class="fa fa-circle-o"></i> ChartJS</a></li>
            <li><a href="<c:url value="/WEB-INF/jsp/pages/charts/morris.html"/>"><i class="fa fa-circle-o"></i> Morris</a></li>
            <li><a href="<c:url value="/WEB-INF/jsp/pages/charts/flot.html"/>"><i class="fa fa-circle-o"></i> Flot</a></li>
            <li><a href="<c:url value="/WEB-INF/jsp/pages/charts/inline.html"/>"><i class="fa fa-circle-o"></i> Inline charts</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="<c:url value="/WEB-INF/jsp/pages/UI/general.html"/>"><i class="fa fa-circle-o"></i> General</a></li>
            <li><a href="<c:url value="/WEB-INF/jsp/pages/UI/icons.html"/>"><i class="fa fa-circle-o"></i> Icons</a></li>
            <li><a href="<c:url value="/WEB-INF/jsp/pages/UI/buttons.html"/>"><i class="fa fa-circle-o"></i> Buttons</a></li>
            <li><a href="<c:url value="/WEB-INF/jsp/pages/UI/sliders.html"/>"><i class="fa fa-circle-o"></i> Sliders</a></li>
            <li><a href="<c:url value="/WEB-INF/jsp/pages/UI/timeline.html"/>"><i class="fa fa-circle-o"></i> Timeline</a></li>
            <li><a href="<c:url value="/WEB-INF/jsp/pages/UI/modals.html"/>"><i class="fa fa-circle-o"></i> Modals</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="<c:url value="/WEB-INF/jsp/pages/forms/general.html"/>"><i class="fa fa-circle-o"></i> General Elements</a></li>
            <li><a href="<c:url value="/WEB-INF/jsp/pages/forms/advanced.html"/>"><i class="fa fa-circle-o"></i> Advanced Elements</a></li>
            <li><a href="<c:url value="/WEB-INF/jsp/pages/forms/editors.html"/>"><i class="fa fa-circle-o"></i> Editors</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
        ...
        <li>
          <a href="<c:url value="/WEB-INF/jsp/pages/calendar.html"/>">
        ...
        <li>
          <a href="<c:url value="/WEB-INF/jsp/pages/mailbox/mailbox.html"/>">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<c:url value="/WEB-INF/jsp/pages/examples/404.html"/>"><i class="fa fa-circle-o"></i> 404 Error</a></li>
            <li><a href="<c:url value="/WEB-INF/jsp/pages/examples/500.html"/>"><i class="fa fa-circle-o"></i> 500 Error</a></li>
            <li><a href="<c:url value="/WEB-INF/jsp/pages/examples/blank.html"/>"><i class="fa fa-circle-o"></i> Blank Page</a></li>
            <li><a href="<c:url value="/WEB-INF/jsp/pages/examples/pace.html"/>"><i class="fa fa-circle-o"></i> Pace Page</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="box box-success">
            ...
            <div class="box-body chat" id="chat-box">
              <!-- chat item -->
              <div class="item">
                <img src="<c:url value="/dist/img/user4-128x128.jpg"/>" alt="user image" class="online">
              ...
              <!-- chat item -->
              <div class="item">
                <img src="<c:url value="/dist/img/user3-128x128.jpg"/>" alt="user image" class="offline">
              ...
              <!-- chat item -->
              <div class="item">
                <img src="<c:url value="/dist/img/user2-160x160.jpg"/>" alt="user image" class="offline">
